...
class User {
    ...
    static async authenticate(username, password){//this username/password valid? Returns boolean
    ...
    static async all() {//info on all users:[{username, first_name, last_name}, ...]
